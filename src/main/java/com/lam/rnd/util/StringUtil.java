...
public final class StringUtil
{
	 ...
	 * 작성일     : 2023.11.06
	 * 작성자     : LookAtMe
	 * 설명       : 문자열을 문자열 조건이 있는 index부터 짤라 반환
	 * </pre>
	 * @param str 문자열
	 * @param condition 조건
	 * @return String
	 *  </pre>
	 **/
	public static String subString(String str, String condition)
	{
		return str.substring(str.indexOf(condition) + 1);
	}
	 ...
	 * 작성일     : 2023.11.06
	 * 작성자     : LookAtMe
	 * 설명       : 문자열을 두 문저열 조건으로 짜름
	 * </pre>
	 * @param str 문자열
	 * @param condition 조건1
	 * @param secCondition 조건2
	 * @return String
	 *  </pre>
	 **/
	public static String subString(String str, String condition, String secCondition)
	{
		return str.substring(str.indexOf(condition) + 1, str.indexOf(secCondition));
	}
